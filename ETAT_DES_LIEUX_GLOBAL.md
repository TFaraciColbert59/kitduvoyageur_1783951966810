...
6. **Performance** : 🟡 **En cours** — Le ratio de pixel WebGL est bridé à 1.0 sur mobile et l'overflow horizontal a été nettoyé, mais le temps LCP critique de 38.6s (issu de l'audit initial) n'a pas encore fait l'objet d'optimisations d'images.
