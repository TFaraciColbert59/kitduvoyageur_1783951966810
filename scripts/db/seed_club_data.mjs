...
async function main() {
  ...
  const botEmail = process.env.AUDIT_EMAIL || (() => { throw new Error('AUDIT_EMAIL est requis'); })();
  const botPassword = process.env.AUDIT_PASSWORD || (() => { throw new Error('AUDIT_PASSWORD est requis'); })();
