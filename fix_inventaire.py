...
content = content.replace("item.condition === \x27en_reparation\x27 || item.condition === \x27a_reparer\x27", "item.condition === \x27\xc3\xa0_r\xc3\xa9parer\x27")
content = content.replace("item.condition === \x27en_entretien\x27 || item.condition === \x27maintenance_requise\x27", "item.condition === \x27\xc3\xa0_remplacer\x27")
