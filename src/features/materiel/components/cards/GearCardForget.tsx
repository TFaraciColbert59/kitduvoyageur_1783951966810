      ...
      <div className="p-2.5 sm:p-5 flex flex-col justify-between h-full gap-1.5 sm:gap-4">
        ...
        <div className="flex items-start justify-between pr-7 md:pr-10 gap-1">
          <div className="space-y-0.5 min-w-0 flex-1">
            ...
            <h2 id="forget-title" className="text-[12px] sm:text-[17px] font-display font-bold text-[#17402C] leading-tight truncate">
              À emporter
            </h2>
          </div>
          <div className="text-right shrink-0">
            <span className={`text-[17px] sm:text-[30px] font-mono font-bold leading-none ${data.forgetRemaining === 0 ? 'text-[#17402C]' : 'text-[#A8443A]'}`}>
              {data.forgetRemaining}
            </span>
            <span className="block text-[8px] sm:text-[9.5px] font-semibold uppercase tracking-wider text-[#5A7064]">
