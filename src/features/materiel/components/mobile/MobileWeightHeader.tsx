    ...
    >
      ...
      <button
        ...
        className={cn(
          ...
          'cursor-pointer transition-transform active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--lkv-primary-hover)]'
        )}
      >
        <svg
        ...
        >
          ...
          <circle
            ...
            className="stroke-[var(--lkv-primary-hover)]/15 dark:stroke-white/10"
          />
          ...
          <motion.circle
            ...
            strokeLinecap="round"
            className="stroke-[var(--lkv-primary-hover)]"
          />
        </svg>

        {/* Center Percentage Display */}
        <span className="absolute inset-0 flex items-center justify-center text-[10.5px] font-bold font-mono tracking-tight text-[var(--lkv-primary)]">
          {clampedPct}%
        </span>
      </button>
      ...
      <div className="flex items-center gap-2 grow min-w-0">
        ...
        >
          ...
          <div className="flex flex-col items-start min-w-0 leading-none">
            <span className="text-[8px] sm:text-[9px] uppercase tracking-wider font-bold text-[var(--lkv-text-muted)] dark:text-stone-400 truncate">
              Base
            </span>
            <span className="text-xs font-mono font-bold text-[var(--lkv-primary)] dark:text-white truncate">
