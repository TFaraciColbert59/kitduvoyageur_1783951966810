  ...
  return (
    <GlassCard as="article" ariaLabelledBy="weather-title" className="p-4">
      ...
      <div className="mt-2 flex gap-2 overflow-x-auto no-scrollbar">
        {cells.map((h, i) => (
          <div key={i} className="bg-white/60 rounded-[var(--r-sm)] h-[72px] w-[56px] shrink-0 flex flex-col items-center justify-center gap-0.5 p-1" title={weatherLabel(h.weathercode)}>
