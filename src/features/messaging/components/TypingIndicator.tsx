...
export const TypingIndicator: React.FC<TypingIndicatorProps> = ({ userNames }) => {
  ...
  return (
    <div aria-live="polite" className="flex items-center gap-2 px-3 py-1.5 text-xs text-[#5A7064] font-medium bg-white/40 backdrop-blur-md border border-white/40 rounded-full shadow-[inset_0_1px_0_rgba(255,255,255,0.6)] w-fit ml-2 mb-1">
