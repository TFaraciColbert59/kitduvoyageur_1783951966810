...
export default function DesktopMapOverlay({
  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden select-none">
      ...
      {activeGuideTurn && (
        <div className="absolute top-16 left-3 right-3 md:left-1/2 md:-translate-x-1/2 md:w-[420px] bg-[#FBFAF6]/95 backdrop-blur-2xl border border-[#17402C]/12 rounded-[0.75rem] p-4 shadow-lg flex items-center gap-3.5 z-30 select-none">
