...
export const AutoGenTripView: React.FC<AutoGenTripViewProps> = ({
  ...
  return (
    <div className="w-full min-h-screen bg-zinc-50 dark:bg-zinc-950 pb-32">
      {/* Barre supérieure : Saisie d'intention */}
      <div className="sticky top-0 z-30 bg-zinc-50/80 dark:bg-zinc-950/80 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800 py-4 px-4">
        <TripBriefBar
      ...
      <div className="max-w-5xl mx-auto px-4 py-6 space-y-6">
        ...
        {tradeoffsLog.length > 0 && (
          <div className="rounded-2xl p-4 bg-emerald-50/70 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/60 text-xs text-emerald-900 dark:text-emerald-200 space-y-1.5">
            <div className="flex items-center font-semibold text-emerald-800 dark:text-emerald-300 gap-1.5 mb-1">
