...
export default function CarnetLoading() {
  return (
    <div className="min-h-screen bg-[color:var(--lkv-surface)]">
      <div className="h-16 border-b border-[color:var(--lkv-border)] bg-[color:var(--lkv-surface-muted)]" />
      ...
      <div className="border-y border-[color:var(--lkv-border)] bg-[color:var(--lkv-surface-muted)] py-[var(--space-8)]">
