...
Les lodges sont confortables jusqu'à Manang, puis plus rustiques. Prévoir des vêtements chauds même en mars — les nuits descendent à -15°C au-dessus de 4000m. Le matériel a été testé à l'extrême et voici ce qui a tenu.`,
    ...
    map_points: [
      ...
      { lat: 28.7167, lng: 83.7167, label: 'Muktinath', day: 12 },
...
Départ de Calenzana le 1er juin, arrivée à Conca le 15. Le GR20 est souvent décrit comme le trek le plus difficile d'Europe, et ce n'est pas une exagération. Les premières étapes dans le massif du Cinto sont particulièrement exigeantes avec des passages en crête exposés.

Les refuges du Parc Naturel Régional sont bien équipés mais réservation obligatoire en saison. Prévoir de l'eau en quantité — certaines étapes n'ont pas de source pendant plusieurs heures.`,
    ...
    end_date: '2026-06-15',
    weather: 'Ensoleillé et chaud (32°C en basse altitude), frais en altitude (12°C), 2 jours de pluie',
    route_rating: 9.5,
    visibility: 'public',
    tags: ['gr20', 'corse', 'france', 'trek', 'montagne'],
    map_points: [
      { lat: 42.5167, lng: 8.8500, label: 'Calenzana — Départ', day: 1 },
      { lat: 42.4500, lng: 8.9167, label: 'Refuge de Carrozzu', day: 2 },
      { lat: 42.3833, lng: 9.0000, label: 'Refuge de Ciottulu', day: 5 },
      { lat: 42.1167, lng: 9.1333, label: 'Refuge de Vizzavona', day: 9 },
  ...
  },
  {
    ...
    title: 'Tour du Mont-Blanc — 11 jours, 3 pays, 170 km',
...
Juillet est la haute saison sur le TMB — les refuges sont complets des mois à l'avance. Réservation indispensable. Nous avons croisé des randonneurs de 40 nationalités différentes, ce qui rend l'expérience encore plus riche.

Le passage par le Col de la Seigne (2516m) avec vue sur le glacier de la Lex Blanche est un moment magique. La descente sur Courmayeur en Italie offre une pause gastronomique bienvenue.`,
    ...
    end_date: '2026-07-16',
    weather: 'Beau temps 8 jours sur 11, orage J6 et J9, températures 5–22°C selon altitude',
    route_rating: 9.8,
    visibility: 'public',
    tags: ['tmb', 'mont-blanc', 'alpes', 'multiday', 'international'],
    map_points: [
      { lat: 45.8833, lng: 6.7833, label: 'Les Houches — Départ', day: 1 },
      { lat: 45.8167, lng: 6.8500, label: 'Les Contamines', day: 2 },
      { lat: 45.7333, lng: 6.9167, label: 'Col de la Seigne (2516m)', day: 3 },
      { lat: 45.7833, lng: 6.9833, label: 'Courmayeur, Italie', day: 4 },
      { lat: 45.9167, lng: 7.0500, label: 'Grand Col Ferret (2537m)', day: 6 },
      { lat: 45.9500, lng: 6.8833, label: 'Chamonix', day: 9 },
      { lat: 45.8833, lng: 6.7833, label: 'Les Houches — Arrivée', day: 11 },
    ],
  ...
  },
  {
    ...
    title: 'Islande — Traversée des Hautes Terres, 8 jours',
    destination: 'Islande, Hautes Terres',
    description: `La traversée des Hautes Terres islandaises via le Landmannalaugar et le Þórsmörk. Un trek sauvage et isolé dans un paysage lunaire.

Août est le seul mois praticable pour cette traversée. Les pistes F sont ouvertes et les rivières sont à leur niveau le plus bas. Malgré tout, nous avons dû traverser 4 rivières à gué — les bâtons de marche sont indispensables.

Les couleurs des rhyolites à Landmannalaugar sont irréelles : rouge, vert, jaune, orange. Les sources chaudes naturelles permettent de se réchauffer après les longues étapes.`,
    cover_image: 'https://images.unsplash.com/photo-1476610182048-b716b8518aae?w=1200&q=80',
    cover_image_alt: 'Paysage volcanique islandais avec montagnes colorées de rhyolite et randonneur',
    start_date: '2026-08-03',
    end_date: '2026-08-11',
    weather: 'Variable : soleil, pluie, vent fort, 2–15°C, neige possible en altitude',
    route_rating: 9.0,
    visibility: 'public',
    tags: ['islande', 'hautes-terres', 'volcan', 'sauvage', 'gué'],
    map_points: [
      { lat: 63.9833, lng: -19.0667, label: 'Landmannalaugar — Départ', day: 1 },
      { lat: 63.9167, lng: -19.2333, label: 'Hrafntinnusker', day: 2 },
      { lat: 63.8500, lng: -19.3500, label: 'Álftavatn', day: 3 },
      { lat: 63.7833, lng: -19.4167, label: 'Emstrur', day: 5 },
      { lat: 63.6833, lng: -19.5167, label: 'Þórsmörk — Arrivée', day: 8 },
    ],
    is_collaborative: false,
    likes_count: 189,
    comments_count: 41,
    ...
    author: { id: 'fake-author-4', full_name: 'Lucas Martin', avatar_url: '', trust_score: 78 },
  },
];
...
const FAKE_COMMENTS: Comment[] = [
  ...
  { id: 'c2', content: 'Quelle marque de sac de couchage tu recommandes pour les températures négatives ? J\'ai prévu le même circuit en octobre.', created_at: '2026-07-03T14:15:00Z', author: { full_name: 'Pierre Moreau', avatar_url: '' } },
  { id: 'c3', content: 'Superbe carnet ! J\'ai fait le même circuit il y a 3 ans, les conditions météo étaient similaires. Ton récit est très fidèle à la réalité.', created_at: '2026-07-05T09:45:00Z', author: { full_name: 'Isabelle Petit', avatar_url: '' } },
];
      ...
      <main className="pt-16">
        {loading ? (
          <div className="max-w-4xl mx-auto px-4 py-12 space-y-6">
            ...
            <div className="h-4 w-1/2 bg-[#C8C3B0]/30 rounded animate-pulse" />
          </div>
        ) : !carnet ? (
          <div className="max-w-4xl mx-auto px-4 py-20 text-center">
            <p className="text-5xl mb-4">🗺️</p>
            <h1 className="font-display font-700 text-2xl text-[#1C2620] mb-2">Carnet introuvable</h1>
            <p className="text-[#5C6B5E] mb-6">Ce carnet n&apos;existe pas ou a été supprimé.</p>
            <Link href="/carnets" className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#E4501C] text-white rounded-xl text-sm font-700 hover:bg-[#E4501C]/90 transition-colors">
              ← Retour aux carnets
            </Link>
          </div>
        ) : (
          <>
            ...
            <div className="relative h-80 md:h-[420px] overflow-hidden bg-[#1C2620]">
              ...
              <div className="absolute top-6 left-6 flex gap-2 flex-wrap">
                {carnet.verified && <span className="text-xs bg-emerald-500 text-white px-3 py-1 rounded-full font-700">✓ Vérifié</span>}
                {carnet.is_collaborative && <span className="text-xs bg-blue-500 text-white px-3 py-1 rounded-full font-700">👥 Collaboratif</span>}
              </div>

              {/* Back button */}
              <div className="absolute top-6 right-6">
                <Link href="/carnets" className="flex items-center gap-2 px-4 py-2 bg-black/40 backdrop-blur-sm rounded-xl text-white text-sm font-600 hover:bg-black/60 transition-colors">
              ...
              <div className="absolute bottom-8 left-6 right-6 max-w-4xl mx-auto">
                ...
                <h1 className="font-display font-800 text-white text-3xl md:text-4xl leading-tight mb-4">{carnet.title}</h1>
                <div className="flex items-center gap-4 flex-wrap">
                  {carnet.author && (
                    <Link href={carnet.author_id && !carnet.author_id.startsWith('fake-') ? `/profil/${carnet.author_id}` : '#'} className="flex items-center gap-2 hover:opacity-80 transition-opacity">
                      <div className="w-8 h-8 rounded-lg bg-[#E4501C]/30 flex items-center justify-center text-sm font-700 text-white">
                        {carnet.author.full_name?.[0] ?? '?'}
                      </div>
                      <span className="text-white/90 text-sm font-600">{carnet.author.full_name}</span>
            ...
            <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
              ...
              <div className="grid grid-cols-5 bg-[#EDEAE0] border border-[#C8C3B0] rounded-2xl divide-x divide-[#C8C3B0] overflow-hidden">
                {[
                  ...
                  <div key={s.label} className="p-4 text-center">
                    ...
                    <p className="font-display font-700 text-[#1C2620] text-base">{s.value}</p>
              ...
              {(carnet.start_date || carnet.end_date) && (
                <div className="flex items-center gap-4 p-5 bg-[#1C2620] rounded-2xl">
                  <Icon name="CalendarDaysIcon" size={22} className="text-[#E4501C] flex-shrink-0" />
                  <div className="flex flex-wrap items-center gap-6 text-sm">
                    {carnet.start_date && (
                      <div>
                        <p className="text-[10px] text-white/40 uppercase tracking-wider mb-0.5">Départ</p>
                    ...
                    {carnet.start_date && carnet.end_date && <div className="text-white/30 text-2xl">→</div>}
                    {carnet.end_date && (
                      <div>
                        <p className="text-[10px] text-white/40 uppercase tracking-wider mb-0.5">Retour</p>
                    ...
                    {durationDays && (
                      <div className="ml-auto">
                        <p className="text-[10px] text-white/40 uppercase tracking-wider mb-0.5">Durée totale</p>
                        <p className="font-mono font-700 text-[#E4501C] text-2xl">{durationDays}j</p>
                      </div>
                    )}
                  </div>
                </div>
              ...
              {carnet.map_points?.length > 0 && (
                <div className="bg-[#EDEAE0] border border-[#C8C3B0] rounded-2xl p-6">
                  <p className="text-[10px] font-mono text-[#5C6B5E] uppercase tracking-wider mb-4">Points d&apos;étape ({carnet.map_points.length})</p>
                  <div className="space-y-2">
                    {carnet.map_points.map((point, i) => (
                      <div key={i} className="flex items-center gap-4 p-3 bg-[#E7E3D6] rounded-xl border border-[#C8C3B0]">
                        <div className="w-8 h-8 rounded-lg bg-[#E4501C] flex items-center justify-center text-white text-xs font-700 flex-shrink-0">
                          {point.day ?? i + 1}
                        </div>
                        ...
                        {point.day && <span className="text-xs text-[#5C6B5E]">Jour {point.day}</span>}
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="flex items-center gap-4 py-4 border-t border-[#C8C3B0]">
                ...
                {carnet.author && carnet.author_id && !carnet.author_id.startsWith('fake-') && (
                  <Link href={`/profil/${carnet.author_id}`} className="ml-auto flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-600 border border-[#C8C3B0] text-[#5C6B5E] hover:text-[#1C2620] transition-all">
                    ...
                    Voir le profil de {carnet.author.full_name}
                  </Link>
                )}
              </div>
                  ...
                  <div className="space-y-4 mb-6">
                    {comments.map((c) => (
                      <div key={c.id} className="flex gap-3">
                        <div className="w-9 h-9 rounded-xl bg-[#E4501C]/20 flex items-center justify-center text-sm font-700 text-[#E4501C] flex-shrink-0">
                          {c.author?.full_name?.[0] ?? '?'}
                        </div>
                        <div className="flex-1 bg-white rounded-xl p-4">
                          <div className="flex items-center justify-between mb-1">
                            <p className="text-sm font-700 text-[#1C2620]">{c.author?.full_name ?? 'Anonyme'}</p>
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  <h2 className="font-display font-700 text-[#1C2620] text-lg">Autres carnets d&apos;expédition</h2>
