...
export default function CarnetError({
  ...
  return (
    <div className="min-h-screen bg-[#E7E3D6] flex flex-col items-center justify-center p-6 text-center">
      <div className="w-16 h-16 rounded-full bg-[#17402C]/5 flex items-center justify-center mb-6">
        <span className="text-3xl">⚠️</span>
      </div>

      <h1 className="font-display font-bold text-2xl md:text-3xl text-[#17402C] mb-3">
        Erreur de chargement du carnet
      </h1>
      
      <p className="text-sm text-[#17402C]/60 max-w-md mb-8">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        ...
        <Link
          href="/carnets"
          className="px-6 py-3 border border-[#17402C]/20 text-[#17402C] rounded-full text-xs font-bold uppercase tracking-wider hover:bg-[#17402C]/5 transition-colors"
        >
          Retour aux carnets
        </Link>
      </div>
