        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-center">
              <p
                className="font-mono font-800 text-3xl text-white transition-all duration-300"
                style={{ fontFamily: 'var(--font-mono)' }}
              >
                {stats.count}
              </p>
              <p className="font-mono text-[10px] text-white/50 uppercase tracking-widest mt-1" style={{ fontFamily: 'var(--font-mono)' }}>
            ...
            {/* Budget used */}
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-center">
              <p className="font-mono font-800 text-3xl transition-all duration-300" style={{ fontFamily: 'var(--font-mono)', color: 'var(--primary)' }}>
              ...
              <div className="mt-2 h-1 rounded-full bg-white/10 overflow-hidden">
                <div
                  ...
                  style={{ width: `${Math.min(100, (stats.budgetUsed / budget) * 100)}%`, background: 'var(--primary)' }}
                />
              </div>
            </div>
            ...
            {/* Weight used */}
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-center">
              <p className="font-mono font-800 text-3xl transition-all duration-300" style={{ fontFamily: 'var(--font-mono)', color: 'var(--info)' }}>
                {stats.weightUsed.toFixed(1)} kg
              </p>
              <p className="font-mono text-[10px] text-white/50 uppercase tracking-widest mt-1" style={{ fontFamily: 'var(--font-mono)' }}>
                / {maxWeight} kg poids
              </p>
              <div className="mt-2 h-1 rounded-full bg-white/10 overflow-hidden">
                <div
                  className="h-full rounded-full transition-all duration-300"
                  style={{ width: `${Math.min(100, (stats.weightUsed / maxWeight) * 100)}%`, background: 'var(--info)' }}
                />
              </div>
            </div>
            ...
            {/* Savings */}
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-center">
              <p className="font-mono font-800 text-3xl text-emerald-400 transition-all duration-300" style={{ fontFamily: 'var(--font-mono)' }}>
          ...
          <div className="mb-10 rounded-2xl border border-primary/30 overflow-hidden" style={{ background: 'var(--card)' }}>
            <div className="px-6 py-4 border-b border-border flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="font-display font-700 text-foreground" style={{ fontFamily: 'var(--font-display)' }}>
                  Kit optimisé pour vous
                </h2>
              </div>
              <button
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
                {optimizedResult.map((item) => (
                  <OptimizationResultCard key={item.product.id} item={item} />
                ))}
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 p-4 rounded-xl border border-border bg-background">
                <div className="text-center">
                  <p className="font-mono font-700 text-xl text-foreground" style={{ fontFamily: 'var(--font-mono)' }}>
                    {optimizationStats.total} €
                  </p>
                  <p className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest mt-0.5" style={{ fontFamily: 'var(--font-mono)' }}>
                    Budget final
                  </p>
                </div>
                <div className="text-center border-x border-border">
                  <p className="font-mono font-700 text-xl" style={{ fontFamily: 'var(--font-mono)', color: 'var(--info)' }}>
                    {optimizationStats.weight.toFixed(1)} kg
                  </p>
                  <p className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest mt-0.5" style={{ fontFamily: 'var(--font-mono)' }}>
                    Poids total
                  </p>
                ...
                <div className="text-center">
                  <p className="font-mono font-700 text-xl text-emerald-600" style={{ fontFamily: 'var(--font-mono)' }}>
