...
const DepensesCard = dynamicImport(() => import('@/components/groupes/DepensesCard'), { ssr: false });
const DecisionsCard = dynamicImport(() => import('@/components/groupes/DecisionsCard'), { ssr: false });
const DiscussionCard = dynamicImport(() => import('@/components/groupes/DiscussionCard'), { ssr: false });
const MobileGroupeView = dynamicImport(() => import('@/components/groupes/MobileGroupeView'), { ssr: false });
