        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              {/* SECTION 02: Le contenu (Dynamic per postType) */}
              <div className="bg-white rounded-3xl p-6 border border-[#E8E4D8] shadow-sm">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 bg-[#F5F2EA] rounded-2xl border border-[#E4E0D4]">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 bg-white border border-[#E4E0D4] rounded-xl text-xs font-semibold"
                        />
                      </div>
                      <div>
                    ...
                    <div className="border border-[#E4E0D4] rounded-2xl overflow-hidden bg-[#F5F2EA]">
                      ...
                      <div className="flex items-center gap-1 px-3 py-2 bg-[#EBE7DC] border-b border-[#E4E0D4] text-xs">
                        <button
                          ...
                          className={`w-7 h-7 rounded-lg font-bold flex items-center justify-center transition-colors ${isBold ? 'bg-[#1C2620] text-white' : 'hover:bg-white/50 text-[#1C2620]'}`}
                        >
                          B
                        </button>
                        <button
                          ...
                          className={`w-7 h-7 rounded-lg italic font-serif flex items-center justify-center transition-colors ${isItalic ? 'bg-[#1C2620] text-white' : 'hover:bg-white/50 text-[#1C2620]'}`}
                        >
                          I
                        </button>
                        <button type="button" className="w-7 h-7 rounded-lg underline flex items-center justify-center hover:bg-white/50 text-[#1C2620]">
                          U
                        </button>
                        <span className="w-px h-4 bg-[#D8D3C4] mx-1" />
                        <button type="button" className="w-7 h-7 rounded-lg font-bold text-xs flex items-center justify-center hover:bg-white/50 text-[#1C2620]">
                          H
                        </button>
                        <button type="button" className="w-7 h-7 rounded-lg font-serif italic text-sm flex items-center justify-center hover:bg-white/50 text-[#1C2620]">
                          “
                        </button>
                        <button type="button" className="w-7 h-7 rounded-lg flex items-center justify-center hover:bg-white/50 text-[#1C2620]">
                          ::
                        </button>
                        <span className="w-px h-4 bg-[#D8D3C4] mx-1" />
                        <button type="button" className="w-7 h-7 rounded-lg flex items-center justify-center hover:bg-white/50 text-[#1C2620]">
              ...
              <div className="bg-white rounded-3xl p-6 border border-[#E8E4D8] shadow-sm">
                ...
                <div
                  ...
                  className="border-2 border-dashed border-[#D1CBB8] rounded-2xl p-8 bg-[#F5F2EA] text-center cursor-pointer hover:border-[#2D5A27] transition-all mb-4"
                >
                  <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center mx-auto mb-2 text-base shadow-sm">
                    ⇪
                  </div>
                ...
                <div className="grid grid-cols-4 gap-3">
                  {photos.map((src, index) => (
                    <div key={index} className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-black/10 group border border-[#E4E0D4]">
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 w-6 h-6 rounded-full bg-black/60 text-white flex items-center justify-center text-xs opacity-80 group-hover:opacity-100 transition-opacity"
                      >
                        ✕
                      </button>
                    </div>
                  ...
                  <button
                    type="button"
                    onClick={() => fileInputRef.current?.click()}
                    className="aspect-[4/3] rounded-2xl border-2 border-dashed border-[#D1CBB8] bg-[#F5F2EA] flex flex-col items-center justify-center text-xs text-[#7A8A7D] font-bold hover:bg-white transition-all"
                  >
              ...
              <div className="bg-white rounded-3xl p-6 border border-[#E8E4D8] shadow-sm">
                ...
                <div className="space-y-4">
                  {/* Linked Adventure & Carnet */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-semibold text-[#1C2620] mb-1.5">Aventure liée</label>
                      <select
                        value={linkedAdventure}
                        onChange={(e) => setLinkedAdventure(e.target.value)}
                        className="w-full px-4 py-3 bg-[#F5F2EA] border border-[#E4E0D4] rounded-2xl text-xs font-semibold text-[#1C2620] focus:outline-none"
                      >
                    ...
                    <div>
                      ...
                      <select
                        value={linkedCarnet}
                        onChange={(e) => setLinkedCarnet(e.target.value)}
                        className="w-full px-4 py-3 bg-[#F5F2EA] border border-[#E4E0D4] rounded-2xl text-xs font-semibold text-[#1C2620] focus:outline-none"
                      >
                  ...
                  {/* Localisation + Functional Detect Button */}
                  <div>
                    ...
                    <div className="relative flex items-center">
                      ...
                      <input
                        ...
                        className="w-full pl-9 pr-24 py-3 bg-[#F5F2EA] border border-[#E4E0D4] rounded-2xl text-xs font-semibold text-[#1C2620] focus:outline-none"
                      />
                      <button
                        type="button"
                        onClick={handleDetectLocation}
                        disabled={isDetectingLocation}
                        className="absolute right-3 px-3 py-1 bg-white border border-[#E4E0D4] rounded-xl text-[10px] font-bold text-[#1C2620] hover:bg-[#F5F2EA] transition-colors"
                      >
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-2 p-2.5 bg-[#F5F2EA] border border-[#E4E0D4] rounded-2xl min-h-[48px]">
                      ...
                      <input
                        ...
                        className="bg-transparent text-xs text-[#1C2620] focus:outline-none px-2 py-1 flex-1 min-w-[120px]"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-2 p-2.5 bg-[#F5F2EA] border border-[#E4E0D4] rounded-2xl min-h-[48px]">
                      ...
                      <input
                        ...
                        className="bg-transparent text-xs text-[#1C2620] focus:outline-none px-2 py-1 flex-1 min-w-[140px]"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-3xl p-6 border border-[#E8E4D8] shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <button
                      ...
                      className={`flex flex-col p-4 rounded-2xl border text-left transition-all ${
                        audience === 'public'
                          ? 'bg-[#EAF0EB] border-[#2D5A27] text-[#1C2620]'
                          : 'bg-[#FAF8F5] border-[#E8E4D8] text-[#5A6A5D]'
                      }`}
                    >
                  ...
                  {/* Joined Clubs List (Filtered strictly to User's Clubs) */}
                  {audience === 'club' && (
                    <div className="pt-2">
                            ...
                            <button
                              ...
                              className={`px-3.5 py-2 rounded-full text-xs font-semibold flex items-center gap-1.5 border transition-all ${
                                selectedClub === c.id
                                  ...
                                  : 'bg-[#F5F2EA] text-[#3A4A3D] border-[#E4E0D4] hover:bg-white'
                              }`}
                            >
                              <span>{c.emoji || '🏕️'}</span>
                              <span>{c.name}</span>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <button
                          key={st.id}
                          type="button"
                          onClick={() => setScheduleTime(st.id as any)}
                  ...
                  <div className="pt-4 border-t border-[#F0ECE1] space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={`w-11 h-6 rounded-full transition-colors p-1 relative ${allowComments ? 'bg-[#2D5A27]' : 'bg-gray-300'}`}
                      >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={`w-11 h-6 rounded-full transition-colors p-1 relative ${crossPost ? 'bg-[#2D5A27]' : 'bg-gray-300'}`}
                      >
            ...
            <div className="lg:col-span-4 space-y-6 sticky top-28">
              ...
              <div className="bg-white rounded-3xl p-5 border border-[#E8E4D8] shadow-sm">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    <img
                      src={user?.user_metadata?.avatar_url || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&q=80'}
                      alt="Avatar"
                      className="w-9 h-9 rounded-full object-cover border border-[#E4E0D4]"
                    />
                    <div>
                      <h4 className="text-xs font-bold text-[#1C2620]">
                        {user?.user_metadata?.full_name || 'Marceline Chevrier'}
                      </h4>
                  ...
                  {title && postType !== 'photo' && (
                    <h3 className="text-xs font-bold text-[#1C2620] leading-snug line-clamp-2">
                      {title}
                    </h3>
                  )}
                  ...
                  {/* Text Excerpt */}
                  <p className="text-xs text-[#5A6A5D] leading-relaxed line-clamp-3">
                    {content}
                  </p>
              ...
              {/* CARD 2: POST BIEN PENSÉ & QUALITY SCORE */}
              <div className="bg-white rounded-3xl p-5 border border-[#E8E4D8] shadow-sm">
                ...
                <p className="text-[11px] text-[#7A8A7D] mb-4">
              ...
              <div className="bg-[#1C2620] text-white rounded-3xl p-5 shadow-lg border border-[#2D3F35]">
                ...
                <p className="text-xs text-white/70 leading-relaxed font-light">
                  C'est l'heure de votre audience — randonneurs actifs — regarde le fil, entre le trajet retour et le dîner.
                </p>
              </div>
          ...
          <div className="container mx-auto max-w-7xl flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={() => handlePublish(true)}
                disabled={isSubmitting}
                className="px-5 py-2.5 bg-white border border-[#E8E4D8] rounded-full text-xs font-bold text-[#3A4A3D] hover:bg-[#FAF8F5] transition-all"
              >
                Enregistrer
              </button>
              <button
              ...
              <button
                onClick={() => handlePublish(false)}
                disabled={isSubmitting}
                className="px-7 py-2.5 bg-[#1C2620] text-white rounded-full text-xs font-bold hover:bg-[#2D3F35] transition-all shadow-md"
              >
