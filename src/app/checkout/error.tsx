...
export default function Error({
  ...
  return (
    <div className="min-h-screen bg-[#EEF3EC] flex flex-col items-center justify-center p-4">
      <div className="glass rounded-xl p-8 max-w-md w-full text-center space-y-6">
        ...
        <h2 className="text-2xl font-display font-700 text-[#17402C]">Une erreur est survenue</h2>
