...
export default function MaterielLayout({ children }: { children: React.ReactNode }) {
  return (
    <div
      ...
      className="relative h-screen md:h-dvh max-h-screen md:max-h-dvh overflow-hidden w-full max-w-full font-sans text-[var(--lkv-primary)] bg-[var(--lkv-surface)] flex flex-col"
    >
