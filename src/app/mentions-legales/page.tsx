      ...
      <div className="hidden md:block">
        <div className="min-h-screen bg-background text-foreground">
          ...
          <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
            <p className="text-xs font-mono text-primary tracking-widest uppercase mb-3">Informations légales</p>
            <h1 className="font-display text-3xl text-foreground mb-2" font-extrabold>Mentions légales</h1>
