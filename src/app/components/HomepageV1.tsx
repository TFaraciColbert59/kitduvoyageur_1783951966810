...
// ─── SECTION 7.5: PRESSE & TÉMOIGNAGES ───────────────────────────────────────
...
const PRESS_MENTIONS = [
  {
    outlet: 'Outdoor Magazine',
    quote: '« La référence pour préparer son kit de randonnée avec l\'IA »',
    logo: '🏔️',
  },
  {
    outlet: 'Le Monde Aventure',
    quote: '« Révolutionne la préparation du voyageur moderne »',
    logo: '🌍',
  },
  {
    outlet: 'Trail Running FR',
    quote: '« Outil indispensable avant chaque expédition »',
    logo: '🏃',
  },
  {
    outlet: 'Bivouac.com',
    quote: '« Sélection produit irréprochable, IA bluffante »',
    logo: '⛺',
  },
];

function PressAndTestimonialsSection() {
