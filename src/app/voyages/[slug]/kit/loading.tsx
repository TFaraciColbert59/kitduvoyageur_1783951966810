    ...
    <AppShell safeTop={true} hasBottomNav={true}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 pb-28 animate-pulse">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="h-32 bg-stone-200/60 rounded-[var(--lkv-radius-xl)]" />
          <div className="h-32 bg-stone-200/60 rounded-[var(--lkv-radius-xl)]" />
          <div className="h-32 bg-stone-200/60 rounded-[var(--lkv-radius-xl)]" />
        </div>

        <div className="h-64 bg-stone-200/60 rounded-[var(--lkv-radius-card)] mb-6" />
        <div className="h-96 bg-stone-200/60 rounded-[var(--lkv-radius-card)]" />
      </div>
    </AppShell>
  );
}
