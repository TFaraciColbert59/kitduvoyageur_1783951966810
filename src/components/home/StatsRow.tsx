  ...
  return (
    <div style={{ padding: '20px 16px' }}>
      <div style={{
        ...
        borderRadius: '18px', overflow: 'hidden', background: 'rgba(23,64,44,0.06)',
      }}>
        <div style={{ background: '#EEF3EC', padding: '16px 8px', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '22px', fontWeight: 600, color: '#17402C' }}>47+</div>
        </div>
        <div style={{ background: '#EEF3EC', padding: '16px 8px', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '22px', fontWeight: 600, color: '#17402C' }}>340</div>
        </div>
        <div style={{ background: '#EEF3EC', padding: '16px 8px', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '22px', fontWeight: 600, color: '#17402C' }}>1.3k</div>
        </div>
      </div>
    </div>
  );
