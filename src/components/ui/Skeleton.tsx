...
export function Skeleton({ className = '' }: { className?: string }) {
  return (
    <div
      className={`bg-gradient-to-r from-[#E8E5DC] via-[#EEF3EC] to-[#E8E5DC] bg-[length:200%_100%] animate-shimmer rounded-xl ${className}`}
    />
  );
}
...
export function SkeletonCarnetCard({ className = '' }: { className?: string }) {
  return (
    <div className={`bg-[#EEF3EC] rounded-2xl p-4 border border-[#17402C]/10 space-y-3  ${className}`}>
...
export function SkeletonClubCard({ className = '' }: { className?: string }) {
  return (
    <div className={`bg-[#EEF3EC] rounded-2xl p-5 border border-[#17402C]/10 space-y-4  ${className}`}>
