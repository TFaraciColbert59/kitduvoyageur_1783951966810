  ...
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    return (
      <div
        ...
        onClick={(e) => { props.onClick?.(e); if (!isControlledRef.current) { svgControls.start("animate"); runPathIntro(); } }}
        onTouchStart={(e) => { props.onTouchStart?.(e); if (!isControlledRef.current) { svgControls.start("animate"); runPathIntro(); } }}
        {...props}
      >
        <motion.svg
          animate={svgControls}
