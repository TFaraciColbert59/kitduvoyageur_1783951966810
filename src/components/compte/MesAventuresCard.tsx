...
export default function MesAventuresCard({ aventures }: MesAventuresCardProps) {
  ...
  return (
    <div className="bg-white rounded-[0.75rem] p-6 sm:p-8 border border-[#1C2620]/5 shadow-sm space-y-6 active:scale-[0.98] active:opacity-95 transition-all duration-150 cursor-pointer">
