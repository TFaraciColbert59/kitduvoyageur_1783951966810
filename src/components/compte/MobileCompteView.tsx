...
export default function MobileCompteView({
  ...
  return (
    <div className="block md:hidden bg-[#F5F3ED] min-h-screen pb-24 text-[#17402C] font-sans">
      
      {/* 1. Compact App Header */}
      <div className="sticky top-0 z-40 bg-[#17402C] text-white px-4 py-3 flex items-center justify-between ">
      ...
      <div className="relative w-full h-60 bg-[#17402C] text-white overflow-hidden p-5 flex flex-col justify-end">
        <Image
        ...
        <div className="relative z-10 flex items-center gap-4">
          <div className="relative shrink-0" onClick={onOpenEdit}>
            <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-white relative  bg-emerald-900 cursor-pointer">
              <Image
            ...
            <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-emerald-400 text-emerald-950 flex items-center justify-center border border-[#17402C] shadow">
      ...
      <div className="px-4 -mt-4 relative z-20 space-y-3">
        <div className="bg-[#17402C] text-white rounded-2xl p-4  border border-white/10 flex items-center justify-between">
        ...
        <Link
          href="/compte"
          className="w-full py-3 bg-[#17402C] hover:bg-[#cc3d10] text-white font-black text-xs rounded-2xl  flex items-center justify-center gap-2 border border-white/10"
        >
      ...
      <div className="sticky top-0 z-30 bg-[#F5F3ED]/95 backdrop-blur-md px-4 py-3 border-b border-[#17402C]/10  transition-all">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-extrabold whitespace-nowrap transition-all touch-manipulation min-h-[44px] flex items-center justify-center shrink-0 ${
                  isActive
                    ...
                    : 'bg-white text-[#17402C]/75 border border-[#17402C]/12 hover:bg-[#EAE7DC] active:bg-[#E2DEC5]'
                }`}
              >
                {t.label}
              </button>
      ...
      <div className="px-4 mt-4">
        <div className="bg-gradient-to-br from-[#17402C] to-[#365233] text-white rounded-2xl p-4  border border-white/10 space-y-3">
      ...
      <div className="px-4 mt-4 grid grid-cols-2 gap-3">
        <div className="bg-white p-3.5 rounded-2xl border border-[#17402C]/5 ">
          <span className="text-[9px] font-mono font-bold text-[#17402C]/50 uppercase block">DISTANCE 2026</span>
          <span className="font-mono font-900 text-xl text-[#17402C] block mt-0.5">{stats.distance_2026.value}</span>
        </div>
        <div className="bg-white p-3.5 rounded-2xl border border-[#17402C]/5 ">
          <span className="text-[9px] font-mono font-bold text-[#17402C]/50 uppercase block">DÉNIVELÉ</span>
          <span className="font-mono font-900 text-xl text-[#17402C] block mt-0.5">{stats.elevation_gain.value}</span>
        </div>
        <div className="bg-white p-3.5 rounded-2xl border border-[#17402C]/5 ">
          <span className="text-[9px] font-mono font-bold text-[#17402C]/50 uppercase block">NUITS REFUGE</span>
          <span className="font-mono font-900 text-xl text-[#17402C] block mt-0.5">{stats.refuge_nights.value}</span>
        </div>
        <div className="bg-white p-3.5 rounded-2xl border border-[#17402C]/5 ">
          <span className="text-[9px] font-mono font-bold text-[#17402C]/50 uppercase block">CONSTANCE</span>
          <span className="font-mono font-900 text-xl text-[#17402C] block mt-0.5">🔥 6 sem.</span>
        </div>
      </div>
    </div>
  );
