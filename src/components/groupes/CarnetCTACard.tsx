...
export default function CarnetCTACard() {
  return (
    <div className="bg-gradient-to-br from-[#E7E3D6] to-[#F1EBE0] rounded-[2rem] p-6 border border-[#B5652D]/20 shadow-sm relative overflow-hidden group">
      <div className="absolute top-0 right-0 w-32 h-32 bg-[#E4501C] opacity-5 blur-[40px] rounded-full pointer-events-none group-hover:opacity-10 transition-opacity" />
      ...
      <h2 className="font-display text-2xl text-[#1C2620] mb-3 leading-tight">
        Ce voyage deviendra un <span className="font-serif italic font-bold text-[#E4501C]">carnet.</span>
      </h2>
      ...
      <button className="w-full py-3 bg-[#E4501C] text-white rounded-full flex items-center justify-center gap-2 text-sm font-bold shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all">
