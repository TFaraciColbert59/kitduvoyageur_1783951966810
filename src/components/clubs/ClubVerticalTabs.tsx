...
export default function ClubVerticalTabs({
  ...
  const tabs = [
    { id: "Vue d'ensemble", label: "Vue d'ensemble", icon: 'HomeIcon' },
    { id: 'Sorties', label: 'Sorties', count: eventsCount, icon: 'CalendarDaysIcon' },
    { id: 'Membres', label: 'Membres', count: membersCount, icon: 'UserGroupIcon' },
    { id: 'Photos', label: 'Photos', icon: 'PhotoIcon' },
    { id: 'Discussions', label: 'Discussions', count: topicsCount, icon: 'ChatBubbleLeftRightIcon' },
    { id: 'Guides & Astuces', label: 'Guides & Astuces', icon: 'BookOpenIcon' },
  ...
  return (
    <nav className="w-full glass p-1.5 rounded-2xl flex flex-col gap-1">
      <div className="px-2 py-0.5 flex items-center justify-between border-b border-[#17402C]/10 mb-0.5">
        <span className="text-[9px] font-mono font-bold uppercase tracking-widest text-[#5C6B5E]">Espaces</span>
