...
export default function ExplorerMap({
  ...
  return (
    <div className="relative w-full h-full bg-[#EAE6DF] overflow-hidden select-none" style={{ width: '100%', height: '100%', touchAction: 'none' }}>
      ...
      <div className="absolute z-[400] pointer-events-auto right-3.5 top-[calc(env(safe-area-inset-top,0px)+16px)] md:top-auto md:right-4 md:bottom-6 flex flex-col items-end gap-2.5">
        {/* Floating Zoom & GPS Controls (+ / − / GPS) — Agrandis pour ergonomie mobile */}
        <div className="flex flex-col gap-2 items-center">
          <button
            ...
            className="glass-circle-btn !w-11 !h-11 md:!w-11 md:!h-11 font-bold text-lg shadow-lg flex items-center justify-center cursor-pointer active:scale-95"
          >
            +
          </button>
          <button
          ...
          <button
            ...
            className="glass-circle-btn !w-11 !h-11 md:!w-11 md:!h-11 shadow-lg flex items-center justify-center cursor-pointer active:scale-95"
          >
        ...
        {/* Tile switcher (Carte / Relief / Satellite) — Liquid Glass (Icônes seules agrandies) */}
        <div
          className="flex items-center gap-1.5 p-1 rounded-full shadow-lg"
          style={{
        ...
        >
          <button
            ...
            className={`!w-10 !h-10 md:!w-10 md:!h-10 rounded-full flex items-center justify-center transition-all cursor-pointer active:scale-95 ${
              tileMode === 'osm'
